...
const gamesData = {
  audiocall: {
    title: "Аудиовызов",
    description:
      "Прокачивайте восприятие языка на слух, а также увеличивайте свой словарный запас. Эта игра улучшает восприятие английского на слух. Выбери слово, которое было произнесено",
    path: "audiocall",
  },
};

export { soundError, soundSuccess, gamesData, formLabel };
